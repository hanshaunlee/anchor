...
AGENT_SPEC: dict[str, dict[str, Any]] = {
    ...
    "recurring_contacts": {
        ...
        "slug": "recurring_contacts",
        "label": "Recurring Contacts",
        "display_name": "Recurring Contacts (Watchlist Weight)",
        "description": "Identifies returning callers and repeat contacts across sessions. Contributes watchlist candidates as an additional weight alongside financial and ring discovery.",
        "tier": INVESTIGATION,
        "triggers": _triggers(AUTOMATIC),
        "visibility": HIDDEN,
        "required_roles": ["caregiver", "admin"],
        ...
        "writes_embeddings": False,
        "run_entrypoint": "domain.agents.recurring_contacts_agent:run_recurring_contacts_agent",
        "supports_dry_run": True,
        "primary_artifacts": ["watchlists"],
        "ui_sections": ["watchlist"],
    },
    "outreach": {
