...
- `docs/api_ui_contracts.md`
- `apps/api/api/routers/*`
- `apps/api/api/schemas.py`

See `docs/frontend_notes.md` for a summary of data objects (HouseholdMe, Session, Event, RiskSignal, Watchlist, Summary, Feedback, WebSocket message).
