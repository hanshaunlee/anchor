...
class PipelineSettings(BaseSettings):
    ...
    persist_score_min: float = Field(0.2, description="Min score to persist risk signal (lower so rule/motif signals appear)")
    min_severity_to_persist: int = Field(1, ge=1, le=5, description="Min severity to persist (1 = show financial + ring_candidate)")
